...
%%
[X1,Y1,lbl1] = signal_generator(20,1,[1024, 1024],1,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,0,[],[],[],[]);
%% BFSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],2,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[20],j,1,1,k,[],[],[]);
%% 4FSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],2,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],2,[20],j,1,1,k,[],[],[]);
%% 8FSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],2,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],2,[20],j,1,1,k,[],[],[]);
%% COSTAS 
% ?????????????????????????
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],2,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],2,[20],j,1,0,k,[],[],[]);
%% 2PSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],1,1,1,k,[],[],[])

%% 4PSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,1,k,[],[],[])

%% 8PSK
[X1,Corr1,Y1,lbl1] = signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],3,1,1,k,[],[],[])
%% BARKER
signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,1,[],[],[])
%% HUFFMAN -- Revisar
signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,2,[],[],[])
%% FRANK -- OK
signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,3,[],[],[])
%% P1 -- ??
[X1,Corr1,Y1,lbl1]= signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,4,[],[],[])
%% P2
[X1,Corr1,Y1,lbl1]= signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,5,[],[],[])
%% P3
[X1,Corr1,Y1,lbl1]= signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,6,[],[],[])

%%
[X1,Corr1,Y1,lbl1]= signal_generator(snr,i_train,[l_s, l_s],3,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],1,[2,5, 10, 15, 20],2,1,0,7,[],[],[])
%%
