...
[status,msg,msgID] = mkdir('Dataset/stft/');
...
switch i
    case 1
        [Xs1,t1,Y1,lbl1] = signal_generator_2d(snr,i_train,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
        [Xs2,t2,Y2,lbl2] = signal_generator_2d(snr,i_test,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
    ...
    case 2
        for j = 1:3
            [Xs1,Y1,lbl1] = signal_generator_2d(snr,i_train,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
            [Xs2,Y2,lbl2] = signal_generator_2d(snr,i_test,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
    ...
    case 3
        cAl = 1;
        for j = 1:3
            [Xs1,Y1,lbl1] = signal_generator_2d(snr,i_train,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[2,5, 10, 15, 20],j,1,cAl,k,[],[],[]);
            [Xs2,Y2,lbl2] = signal_generator_2d(snr,i_test,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[2,5, 10, 15, 20],j,1,cAl,k,[],[],[]);
        ...
        cAl = 0;
        for k = 1:13
            [Xs1,Y1,lbl1] = signal_generator_2d(snr,i_train,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[7 10 15 20],j,1,cAl,k,[],[],[]);
            [Xs2,Y2,lbl2] = signal_generator_2d(snr,i_test,[1024, 1024],i,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[7 10 15 20],j,1,cAl,k,[],[],[]);
    ...
    case 4
        ...
        fprintf('NM stored\n');
    case 5
        [Xs1,Y1,lbl1] = signal_generator_2d(snr,i_train,[1024, 1024],8,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
        [Xs2,Y2,lbl2] = signal_generator_2d(snr,i_test,[1024, 1024],8,[1/20, 1/4],[],[],[],[1, 2, 5, 10, 15],[1/100, 1/20],j,[20],j,1,cAl,k,[],[],[]);
