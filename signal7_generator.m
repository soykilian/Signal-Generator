...
function [X,Y,lbl]=signal7_generator(SNR,iteraciones,T,rTipoSig,BWc,T1_rel,Tcesc,Dfesc,vsFSK,Dffsk,nFSK,vsPSK,nPSK,pAl,cAl,cod,vsASK,vsQAM,Roff)
    ...
    Y = zeros(length(SNR)*iteraciones, 7);
